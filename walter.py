...
# lógica de esta madre

# paso 1: preguntar nombre, apellido y edad. [Enter]
# paso 2: ingresar datos en la base de datos, comparar si corresponden con algun dato
# paso 3: si corresponden regresar el resultado de esa libreria, si no corresponden 
#         ejecutar la funcion de generar fortuna en aleatorio.
# paso 4: imprimir parrafo
# paso 5: preguntar si hay alguna otra persona que quiera saber su fortuna
# paso 6: si la respuesta es "no" se termina el programa
#         si la respuesta es "si" se regresa al paso 1
...
# signo = (input(''' 
# ¿Cuál es signo zodiacal?: '''))

# fortuna = [
# 'las pruebas en la vida siempre sirven para avanzar',
